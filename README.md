...
- Каждая major-версия закрывает в сумме ровно 50 `Issue` по `API`-библиотеки.
- Каждая minor-версия закрывает в сумме ровно 25 `Issue` по `API`-библиотеки.
- Каждая сборка minor-версии закрывает в сумме ровно 5 `Issue` по `API`-библиотеки.
