...
namespace ABCNET.Utils
{
    ...
    public static class SortedDictionary
    {
        ...
        public static SortedDictionary<TKey, TValue> Of<TKey, TValue>(params KeyValuePair<TKey, TValue>[] values)
        {
            if (values is null)
        ...
        /// <returns>Словарь.</returns>
        public static SortedDictionary<TKey, TValue> By<TKey, TValue>(int count, Func<int, KeyValuePair<TKey, TValue>> selector, int firstIndex = 0)
        {
            if (count < 0)
        ...
        /// <returns>Словарь.</returns>
        public static SortedDictionary<TKey, TValue> By<TKey, TValue>(int count, KeyValuePair<TKey, TValue> first, Func<KeyValuePair<TKey, TValue>, KeyValuePair<TKey, TValue>> next)
        {
            if (count < 0)
                throw new ArgumentOutOfRangeException(nameof(count));
            if (next is null)
